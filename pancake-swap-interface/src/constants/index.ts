...
export const ROUTER_ADDRESS = '0xBa4f20873dF09347F14c38c870088504Bc1fC440'
...
const WETH_ONLY: ChainTokenList = {
  [ChainId.MAINNET]: [WETH[ChainId.BSCTESTNET]],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [
    [
      new Token(ChainId.BSCTESTNET, '0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82', 18, 'CAKE', 'PancakeSwap Token'),
      new Token(ChainId.BSCTESTNET, '0xE7D1B7B2f7850B114E2E586B01a8be4F198ac89d', 18, 'WBNB', 'Wrapped BNB'),
    ],
    [BUSD, USDT],
    [DAI, USDT],
  ],
